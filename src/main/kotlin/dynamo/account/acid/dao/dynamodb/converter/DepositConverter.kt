...
class DepositConverter : Converter<Deposit> {

  override fun load(doc: Map<String, AttributeValue>): Deposit {
    return Deposit(
  ...
  override fun convert(entity: Deposit): Map<String, AttributeValue> {
    return mapOf(
